...
tl.to(".contenedor_header", { opacity: 0, duration: 30, ease: "power2.out" })
  ...
  function setOpacity() {
    gsap.set(".first_section", { opacity: 0 });
      ...
      // Configura una consulta de medios para ajustar la posición en tamaños de pantalla más pequeños
...
// Ejecutar la función al cargar la página
  ...
  // Actualizar la función cuando cambie el tamaño de la ventana
  window.addEventListener("resize", executeAnimations);
});